...
Un formato di codifica audio con perdita riduce la risoluzione in bit del suono e rimuove le frequenze che l'essere umano non può sentire o sente poco (secondo un modello psicoacustico) \parencite{AudioSignalProcessingAndCoding}.
