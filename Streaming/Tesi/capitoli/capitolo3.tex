...
\subsection{Audio}
\textit{MPEG-1 Audio} riduce il quantitativo di dati da utilizzare per l'audio tramitete psicoacustica, eliminado frequenze che l'orecchio umano non può sentire. Lo standard sonoro è diviso in 3 layer:
...
Come detto nel paragrafo \ref{subsec:chap3_LibJavascript}, la libreria \textit{JSMpeg} supporta \textit{MP2}. 
