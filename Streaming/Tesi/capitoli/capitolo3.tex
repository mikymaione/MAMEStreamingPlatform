...
\begin{lstlisting}[backgroundcolor = \color{grigiochiaro}, language=C++, numbers=left, tabsize=4, captionpos=b, caption=Codice di hook per la libreria SDL, label={lst:hookCode}]
