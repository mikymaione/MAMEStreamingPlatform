...
MPEG-1 è uno standard del \textit{Moving Pictures Experts Group} del 1991 per la compressione audiovisiva con perdita.
...
\subsection{Video}
È stato progettato per un bit-rate di 1,5 Mbit/s.
