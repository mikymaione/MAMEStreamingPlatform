...
La codifica predittiva mira a ridurre i dati trasmessi calcolando il movimento degli oggetti in una sequenza video, risparmiando tra il 50\% e il 80\% di bit da memorizzare. Il metodo, che si applica solamente ai \textit{P-frame} e \textit{B-frame}, esegue i seguenti passaggi:
...
Un esempio del suo funzionamento è visibile in Fig. \ref{fig:I_P_and_B_frames}.

\begin{figure}[H]
	\includegraphics[width=\linewidth]{immagini/I_P_and_B_frames}
	\caption{Esempio di codifica predittiva. Le frecce partono dal frame di riferimento al frame di predizione. Fonte: wikipedia.org}
