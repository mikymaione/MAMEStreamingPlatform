...
Il trasporto definisce il modo in cui il filmato viene compresso in byte per la trasmissione da una parte all'altra, utilizzando un protocollo. Ad esempio MPEG-TS e RTMP sono contenitori \parencite{RetiInternetMultimediali}.
