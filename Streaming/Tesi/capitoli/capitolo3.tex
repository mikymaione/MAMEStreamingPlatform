...
\begin{enumerate}
    ...
    \item Viene applicata, su ogni blocco, la trasformata discreta del coseno monodimensionale (DCT 1D) prima orizzontalmente e poi verticalmente;
...
I blocchi degli \textit{I-frame} sono trasformati dal dominio spaziale a quello delle frequenze utilizzando la DCT (1D) che viene eseguita sui blocchi da $8\times8$ px della luminanza e della crominanza. Questo processo divide l'immagine in parti (in sottobande spettrali) di diversa importanza \parencite{HyesookLim2000Asaf}. La DCT (1D) è definita in Eq. \ref{eq:DCT}:
