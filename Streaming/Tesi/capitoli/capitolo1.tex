...
Nel prossimo paragrafo vedremo i procolli di comunicazione maggiormente usati.
...
Su questi protocolli di comunicazione sono stati costruiti servizi, tecnologie e Web API utilizzate sia per lo sviluppo web sia per lo streaming \parencite{Audio_and_video_delivery}, schematizzati in Fig. \ref{fig:webprotocols}, ma solo quattro possono essere utilizzati per lo streaming:
...
\begin{table}[H]
	...
	\begin{tabular}{||l l r r r||} 
		\hline
		Piattaforma & Tipo & Risoluzione\footnote{Risoluzione video misurata in linee verticali.} & Bit-rate\footnote{Bit-rate misurato in Mbps.} & Protocollo \\
		\hline\hline
