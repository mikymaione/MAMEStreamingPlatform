...
Il cloud computing offre tre modelli di servizio\footnote{La sigla "aaS" sta per "as a Service".}: infrastruttura (IaaS), piattaforma (PaaS) e software (SaaS). Il cloud gaming è l'unione del modello SaaS, poichè i videogiochi sono offerti come un servizio dal punto di vista del giocatore, e del modello PaaS che dal punto di vista dello sviluppatore ha bisogno del sistema operativo e degli SDK; per questo il paradigma implementato dal cloud gaming è definito "gioco come servizio" (GaaS) e si divide in tre instanze \parencite{Cloud_for_Gaming}, come mostrato in Fig. \ref{fig:GaaS}, che sono:
