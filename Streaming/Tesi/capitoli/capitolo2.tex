...
\begin{itemize}	
	...
	\item Diretto: questo metodo da la possiblità di leggere lo stato dei devices in qualsiasi momento in modo asincrono.
\end{itemize}

\parencite{FocusOnSDL}
%SDL_Event
%SDL_Joystick
