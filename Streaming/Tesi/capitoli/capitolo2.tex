...
\begin{enumerate}
    \item Trasforma le primitive geometriche in un sistema di coordinate universali;
    \item Ritaglia porzioni delle primitive che fuoriescono dalla finestra di visualizzazione;
    \item Trasforma le primiteve ritagliate portandole dalle cordinate universali a quelle dello schermo;
    \item Attraverso algoritmi di rasterizzazione\footnote{La rasterizzazione è il processo di approssimazione delle primitive geometriche in immagini bitmap.} genera l'immagine finale.
\end{enumerate}
