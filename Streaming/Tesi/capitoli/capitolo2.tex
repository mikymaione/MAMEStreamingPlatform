...
Come detto precedentemente La fase di rendering nel MAME 
In Fig. \ref{fig:mame_render_class_diagram} è visibile un diagramma delle classi relativo alla sola funzionalità di rendering da cui è stato estrapolato il diagramma parziale di Fig. \ref{fig:render_class_generic}. 
...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{immagini/render_class_generic}
	\caption{Diagramma delle classi relative al rendering}
	\label{fig:render_class_generic}
\end{figure}
