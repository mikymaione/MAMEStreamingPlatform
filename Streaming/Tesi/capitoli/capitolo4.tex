...
\begin{figure}[H]
	\centering
	\includegraphics[keepaspectratio,width=\textwidth,height=\textheight]{immagini/BMP_MPEG_compare}
	\caption{Comparazione tra rendering RGBA (sx) e streaming in MPEG-1 (dx)}
