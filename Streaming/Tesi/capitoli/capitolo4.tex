...
La codifica \textit{MPEG-1 Video} utilizzata ha dato un valore PSNR di $27.703$ \si{dB} e un indice SSIM di $0.899$. Alcuni esempi sono visibili in Fig. \ref{fig:BMP_MPEG_compare}.
