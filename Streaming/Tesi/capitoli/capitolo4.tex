...
Tramite lo script in Lis. \ref{lst:PyPSNR_SSIM} sono stati calcolati per la codifica \textit{MPEG-1 Video} il valore PSNR di $27.703$ \si{dB} e l'indice SSIM di $0.899$. Alcune immagini d'esempio sono visibili in Fig. \ref{fig:BMP_MPEG_compare}.
