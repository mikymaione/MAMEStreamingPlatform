...
\begin{figure}[H]
	...
	\caption{Alcuni frame d'esempio: a sinistra i frame renderizzati dal MAME (RGBA), a destra i frame codificati in MPEG-1. © Capcom, Data East, Taito}
...
Tramite lo script in Lis. \ref{lst:PyPSNR_SSIM} è stata calcolata la qualità video per la codifica \textit{MPEG-1 Video} che ha dato come risultati un valore di PSNR di $27.703$ \si{dB} e un indice SSIM di $0.899$. Alcune immagini d'esempio del risultato ottenuto sono visibili in Fig. \ref{fig:BMP_MPEG_compare}.
