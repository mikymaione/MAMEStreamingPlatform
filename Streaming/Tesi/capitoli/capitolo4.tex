...
Il PSNR, in Eq. \ref{eq:PSNR}, è comunemente usato come misura della qualità della ricostruzione nella compressione e nella riduzione del rumore dell'immagine. Esistono diversi approcci per calcolare il PSNR di un'immagine a colori, ad esempio utilizzando un'immagine nel formato YCbCr calcolando il PSNR solo sul canale della luminanza \parencite{AnewcombinedPSNRforobjectivevideoqualityassessment}.
...
\begin{itemize}
	...
	\item $l(f,g)$ è la funzione di comparazione del contrasto tra le deviazioni standard $\sigma_f$ e $\sigma_g$;
