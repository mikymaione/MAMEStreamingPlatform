...
Il PSNR, in Eq. \ref{eq:PSNR}, è comunemente usato come misura della qualità della ricostruzione nella compressione e nella riduzione del rumore dell'immagine \parencite{relationship_PSNR_and_SSI}.
