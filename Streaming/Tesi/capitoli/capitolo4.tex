...
La latenza è un problema che non può essere eliminato nel cloud gaming poiché alle fasi di un videogioco: ricezione input, esecuzione, rendering, display; vanno ad aggiungersi: invio al server dell'input utente, codifica audio-video, trasmissione, decodifica audio-video. Un leggero ritardo in un film in streaming o in una videochiamata molto probabilmente passa inosservato, ma durante una partita la latenza può rendere il gioco ingiocabile, una tempistica di esempio è visibile in Fig. \ref{fig:latenzaCloudGaming}, fortunatamente il rapido sviluppo delle reti a banda larga hanno reso questo problema meno evidente e il cloud gaming una realtà \parencite{Cloud_Gaming_Architecture_and_Performance}.
...
Secondo diversi studi, affinché il gameplay sia fluido e senza jitter, il ritardo tra la trasmissione della reazione dell'utente e la visualizzazione del frame corrispondente, chiamato anche round trip delay, deve essere inferiore a 200 millisecondi. Se il ritardo di andata e ritorno è maggiore di 200 msec, la reazione dell'utente viene visualizzata con un ritardo irritante che rende il gioco molto difficile, soprattutto nei giochi in cui la velocità è un fattore molto importante, come gli sparatutto in prima persona e i giochi di strategia in tempo reale.

Come mostrato in tabella \ref{table:Ritardo_tollerato_per_tipo_di_gioco}, ciao \parencite{Cloud_Gaming_Architecture_and_Performance}.
...
\subsubsection{Risultati ottenuti}
Risultati ottenuti, come mostrato in Tab. \ref{table:LatenzaOttenuta}, ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti ottenuti.
