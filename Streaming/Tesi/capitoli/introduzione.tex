...
\cite{GamingAnywhere}
\cite{Latency_analysis_for_M2M}
\cite{Network_Analysis_of_the_Sony_Remote_Play_System}
\cite{Network_technology_for_transmission_of_visual_information}
\cite{Timely_cloud_gaming}
\cite{Use_of_Cloud_Gaming_in_Education}
