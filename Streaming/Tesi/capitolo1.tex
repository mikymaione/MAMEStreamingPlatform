...
Al CES\footnote{Consumer Electronics Show (CES), è una fiera annuale dell'elettronica di consumo.} 2012 Beijing Cloud Union ha presentato il suo omonimo servizio di cloud gaming con 64 videogiochi tra cui alcuni titoli per PlayStation 3. Il servizio fu presentato tramite pagina web e tramite app per Android ed iPhone. Oggi la piattaforma consta di 20 milioni di abbonati ma il servizio è disponibile solo in Cina\cite{CloudUnion}.
