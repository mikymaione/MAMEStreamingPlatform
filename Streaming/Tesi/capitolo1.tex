...
\begin{figure}[H]
	\includegraphics[width=\linewidth]{immagini/timeline_cloud}
	\caption{Sequenze temporale del cloud gaming}
	\label{fig:timeline_cloud}
\end{figure}
