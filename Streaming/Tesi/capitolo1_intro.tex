...
A key feature of the system is usability and for this reason, on the client side, the web browser was the most obvious choice. Among the communication APIs implemented by modern browsers we find: XMLHttpRequest (XHR), Server-Sent Events (SSE), WebSocket, Web Real-Time Communication.
