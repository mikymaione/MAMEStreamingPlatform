...
\chapter*{Sommario}
Negli ultimi anni sono apparsi molti tipi di servizi che sfruttano il paradigma del cloud computing per offrire servizi per: archiviare i file (Dropbox), ascoltare la musica (Spotify), vedere i film e le serie TV (Netflix), utilizzare la suite per l'ufficio (Office 365) e a partire dal 2011 anche videogiocare tramite il cloud gaming.
